...
// Shared shell for the unauthenticated auth screens (login, forgot-password,
// reset-password): the full-bleed teal brand hero plus the white form panel.
// Each page renders only its form into the panel.
const VALUE_PROPS = [
...
export default function AuthLayout({ children }: { children: ReactNode }) {
  return (
    ...
    >
      ...
      >
        ...
        <div className="relative mt-10 flex max-w-[560px] flex-col gap-6 lg:mt-0">
          {/* Marketing headline — decorative, kept out of the heading outline so
              each form's h1 stays the page's single h1. */}
          ...
          <p className="text-lg text-[var(--color-footer-text)] opacity-85">
            Zentrale Erfassung, klare Prioritäten und Wiedervorlagen — damit
            kein Kandidat im Posteingang verloren geht.
          </p>
      ...
      {/* Form panel — white surface; right column on desktop, overlapping card on mobile */}
